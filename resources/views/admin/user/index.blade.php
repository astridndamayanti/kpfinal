							...
							<div class="panel-body">
								<table id="table" class="table table-hover">
									...
									<tr>
										...
										<td class="text-center"><a href="/admin/user/{{$u->id}}/edit" class="lnr lnr-pencil"></a><a href="/admin/user/{{$u->id}}/delete" class="lnr lnr-trash" style="margin-left: 5px;" onclick="return confirm('Are you sure?')"></a></td>
									</tr>
									@endforeach
									</tbody>
								</table>
